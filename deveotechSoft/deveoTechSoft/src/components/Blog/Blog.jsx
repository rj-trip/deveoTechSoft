      ...
      <div className="bg-gray-50 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-orange-500 font-semibold">Your Digital Growth Partner..</span>
          </div>
        </div>
      </div>

      <div className="flex flex-col md:flex-row w-full p-0 md:p-10 gap-6">
        ...
        <div className="w-full md:w-4/5 pr-2">
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <img
              ...
              className="w-full p-1 h-60 md:h-80 object-cover"
            />
            <div className="p-6">
              ...
              <div className="bg-gray-10 p-1 md:p-2 rounded-md shadow-sm mb-4 border border-gray-200">
