    ...
    <div className="bg-white">
      ...
      <div className="px-4 md:px-16 lg:px-32 py-10 space-y-16 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-2xl font-semibold mt-4">What is the need of Mobile Application Software?</h3>
          <p>Mobile application software helps to connect with the customers easily and build the brand quickly with reliable trust.</p>
          <h3 className="text-2xl font-semibold mt-4">What is the cost of Mobile Application Software in Delhi?</h3>
          <p>The cost of Mobile Application Software in Delhi depends on the type of mobile application you want to make and the features you want to add in the software.</p>
          <h3 className="text-2xl font-semibold mt-4">What is the best Mobile Application Software Company in Delhi?</h3>
          <p><a href='https://www.deveotechsoft.com/' className='text-blue-500'> Devotec software solutions </a> is the best mobile application software company in Delhi.</p>
          <h3 className="text-2xl font-semibold mt-4">Which is the best Mobile Application Software Company near me in Delhi?</h3>
          <p><a href='https://www.deveotechsoft.com/' className='text-blue-500'> Devotec software solutions </a> is the best mobile application software company near me in Delhi.</p>
          <h3 className="text-2xl font-semibold mt-4">Which is the best Mobile Application Software Company in Rohini Delhi?</h3>
          <p><a href='https://www.deveotechsoft.com/' className='text-blue-500'> Devotec software solutions </a> is the best mobile application software company in Rohini Delhi.</p>
        </div>
      </div>
    </div>
  );
